<?php 
  ...
  if (isset($_POST['simpan'])) {
    ...
    $sql = "UPDATE user set nama='$nama', username='$username', Level='$level' where id_user='$id'";
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <select name="level" class="form-control custom-select">
                ...
                <option value="operator" <?php if($data['level']=='operator'){echo'selected';} ?>>Penilai</option>
              </select>
            </div>
          </div>
          <!-- /.box-body -->
